...
h.Label.FontSize = 12;
%title(h,'gwB/m2','fontsize',15);
title('Temp','fontsize',14); % ' (' num2str(round(Biom07_2010*1e-15,0)) ' Gt)'
% set(h,'tickdir','out')
caxis([Pmin Pmax])
set(gcf,'color','w');